...
class BaseController extends Controller{
	...
	protected function initialize(){	
		...
		//不用用户登录可以访问的页面
		$no_user_id_arr	= array('callback','callBack','code','login','getdownloadurl','checkslogin','sendsmscode','register','checksmsresetpw','resetpassword','backdata','createorder','orderlist','orderrecordlist','repayment','signin','gettaskranklist','gettaskclasslist','getvipuserexpire','gettasklist','gettaskinfo','taskordertrial');
